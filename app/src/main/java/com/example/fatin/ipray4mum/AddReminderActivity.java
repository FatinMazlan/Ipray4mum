...
import com.example.fatin.ipray4mum.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (days >= 0 && days < 13) {
                final String[]paths = {"Surah Al-Fatihah", "Surah Luqman", "Surah Yaasin", "Surah Al-Inshirah", "Surah Inshiqaq"};

                spinner = (Spinner)findViewById(R.id.reminder_spinner);
                ArrayAdapter<String>adapter = new ArrayAdapter<String>(AddReminderActivity.this,
                ...
                final String[]paths = {"Surah Al-Fatihah", "Surah Yusuf", "Surah Yaasin", "Surah Al-Inshirah", "Surah Inshiqaq"};
                ...
                final String[]paths = {"Surah Al-Fatihah", "Surah Yaasin", "Surah Inshiqaq", "Surah Al-Inshirah", "Surah Maryam", "Surah Hujurat", "Surah At-Taubah"};
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        ((TextView) findViewById(R.id.reminder_title)).setText(spinnerText);
        ((TextView) findViewById(R.id.reminder_title)).setTextColor(Color.WHITE);
